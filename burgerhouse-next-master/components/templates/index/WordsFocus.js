...
const TrueFocus = ({
  ...
  return (
    <div
      className="relative flex gap-4 items-center flex-wrap mt-10 p-6 text-white-smoke"
      ref={containerRef}
    >
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            className="relative text-3xl min-[500px]:max-md:text-4xl md:text-[3rem] font-black cursor-pointer"
            style={{
              filter: manualMode
                ? isActive
                  ? `blur(0px)`
